...
func NewEtcdV3PropsConfigSource(address, root string) *EtcdV3PropsConfigSource {
    return NewEtcdV3PropsConfigSourceByName("", address, root, CONSUL_WAIT_TIME)
}
...
func NewEtcdV3PropsCompositeConfigSource(contexts []string, address string) *CompositeConfigSource {
