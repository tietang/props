...
func TestPlaceholder_Eval(t *testing.T) {
	p := NewMapProperties()
	p.Set("orign.key1", "v1")
	p.Set("orign.key2", "v2")
	p.Set("ph.key1", "${orign.key1}")
	...
	conf := NewDefaultCompositeConfigSource(p)
	Convey("Test CompositeConfigSource Placeholder", t, func() {
		Convey("ph muti depth composite", func() {
			So(conf.GetDefault("ph.key1", ""), ShouldEqual, conf.GetDefault("ph.key1", ""))
			So(conf.GetDefault("ph.key2", ""), ShouldEqual, conf.GetDefault("ph.key2", ""))
			So(conf.GetDefault("ph1.key1", ""), ShouldEqual, conf.GetDefault("ph.key1", ""))
			So(conf.GetDefault("ph1.key2", ""), ShouldEqual, conf.GetDefault("ph.key2", ""))
			So(conf.GetDefault("ph2.key1", ""), ShouldEqual, conf.GetDefault("ph.key1", ""))
			So(conf.GetDefault("ph2.key2", ""), ShouldEqual, conf.GetDefault("ph.key2", ""))
			//
			So(conf.GetDefault("ph.key1", ""), ShouldEqual, conf.GetDefault("ph1.key1", ""))
			So(conf.GetDefault("ph.key2", ""), ShouldEqual, conf.GetDefault("ph1.key2", ""))
			So(conf.GetDefault("ph2.key1", ""), ShouldEqual, conf.GetDefault("ph1.key1", ""))
			So(conf.GetDefault("ph2.key2", ""), ShouldEqual, conf.GetDefault("ph1.key2", ""))
