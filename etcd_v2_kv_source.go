...
func NewEtcdKeyValueConfigSource(address, root string) *EtcdV2KeyValueConfigSource {
    return NewEtcdKeyValueConfigSourceByName("", address, root, CONSUL_WAIT_TIME)
}
...
func NewEtcdKeyValueCompositeConfigSource(contexts []string, address string) *CompositeConfigSource {
