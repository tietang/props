...
func NewEtcdPropsConfigSource(address, root string) *EtcdV2PropsConfigSource {
    return NewEtcdPropsConfigSourceByName("", address, root, CONSUL_WAIT_TIME)
}
...
func NewEtcdPropsCompositeConfigSource(contexts []string, address string) *CompositeConfigSource {
